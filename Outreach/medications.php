	...
	<tr>
		...
		<div class="myDiv">
			...
			<tbody>            
				...
				$query = "SELECT m.itm_ID, m.med_lnkID, m.med_dlkID, m.med_Comments, m.med_Dose, m.Unit, m.med_Frequency, m.med_Route, m.Outcome, m.Duration_Time, DATE_TO_CHAR(m.End_Date,'yyyy-Mm-Dd') AS END_DATE,

...
print      "        <tr>
                        <td class='searchRow' data-condid='".$row['COND_ID']."' data-condesc='".$row['CON_DESCRIPTION']."' data-conval='".$row['CON_VALUE']."' data-procid='".$row['PROC_ID']."' data-prodesc='".$row['PRO_DESCRIPTION']."' data-proval='".$row['PRO_VALUE']."' data-proID='".$row['PROC_ID']."' data-sitdesc='".$row['SIT_DESCRIPTION']."' data-sitval='".$row['SIT_VALUE']."' data-sitID='".$row['SITE_ID']."' data-sysdesc='".$row['SYS_DESCRIPTION']."' data-sysval='".$row['SYS_VALUE']."' data-sysID='".$row['SYS_ID']."'>".$row['CON_DESCRIPTION']."</td>
                    </tr>";
